            ...
            <nav className="container mx-auto max-w-screen-xl">
                ...
                <div className={`lg:flex flex-grow justify-end ${isMobileMenuOpen ? 'block' : 'hidden'}`} id="mobile-menu-2">
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            <li>
                                <NavLink  to="/" onClick={toggleMobileMenu} className="block py-2 pr-4 pl-3 text-white rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white" aria-current="page">Home</NavLink>
                            </li>
                            <li>
